...
<center>
 ...
 <?php
	if(isset($_POST['time']))
	{
		...
		echo "<label><h2><b><font weight='bold'><b>Source:  ". $source;
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "Destination:  ". $destination."</label></h2></font></b>";
...
<table align="center" cellpadding="5" style="width:1000px" height="50px" border="2" border-radius="5px">
  ...
  <?php
	...
	$cursor=$collection->find(array("source" => $source,"destination" => $destination))->sort(array('duration' => 1));
