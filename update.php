<html>
<head>
    <title>TRAINEES-Admin-Update Page</title>
...
<body>
    ...
    <div class="container">
		...
		<li style="float:right"><a href="logout.php">LOGOUT</a></li>
			...
			<div class="page-header">
		<h4>
		<font size="6" weight="bold">Enter the updated information.</font></h4><br>
<table>
		<tr><td><label><h2>Train no. : </h2></label></td><td><font size="5"><input type="text" name="train_no"></font><br></td></tr>
		<tr><td><label><h2>Train name : </h2></label></td><td><font size="5"><input type="text" name="train_name"></font><br></td></tr>
		<tr><td><label><h2>Source : </h2></label></td><td><font size="5"><input type="text" name="src"> </font><br></td></tr>
		<tr><td><label><h2>Destination : </h2></label></td><td><font size="5"><input type="text" name="dest"></font><br></td></tr>
		<tr><td><label><h2>Departure : </h2></label></td><td><font size="5"><input type="text" name="departure"></font><br></td></tr>
		<tr><td><label><h2>Arrival :</h2></label></td><td><font size="5"> <input type="text" name="arrival"></font><br></td></tr>
		<tr><td><label><h2>Number of days : </h2></label></td><td><font size="5"><input type="number" name="days"</font><br></td></tr>
		<tr><td><label><h2>Duration : </h2></label></td><td><font size="5"><input type="number" name="duration"></font><br></td></tr>
		...
		<button type="submit" class="btn btn-primary" name="sub1"><font size="5" >&nbsp;&nbsp;GO&nbsp;&nbsp;   </font></button>
		</form>
	</div>
</div>
</div>
